...
spatial_distribution_ent15_2017 <- mexico_city_trips_2017 %>%
  distinct(MUN) %>%
...
write.csv(spatial_distribution_ent15_2017, "municipal_level_analysis/export/ent15_trip_categories_17.csv", row.names = FALSE)