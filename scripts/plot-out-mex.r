...
tables<-read.csv("data/out-mex.csv")
...
ggplot(percent_2007, aes(x = reorder(x, X2007), y = X2007, fill = x)) +
  ...
  labs(title = "Percentage of Trips by Mode in 2007 (out-mex)",
...
ggplot(percent, aes(x = reorder(x, X2017), y = X2017, fill = x)) +
  ...
  scale_fill_brewer(palette = "Set3") +
  labs(title = "Percentage of Trips by Mode in 2017 (out-mex)",
       x = "Mode of Transportation",
       y = "Percentage of Trips (%)") +
  theme_minimal() +
  theme(
...
ggplot(metro_2007,
  ...
  scale_fill_brewer(palette = "Set3") +
  labs(title = "Percentage of  Multimodal Metro Trips in 2007 (out-mex)",
...
ggplot(metro_2017,
  ...
  scale_fill_brewer(palette = "Set3") +
  labs(title = "Percentage of  Multimodal Metro Trips in 2017 (out-mex)",
       x = "Metro & Light Rail Lines",
       y = "Percentage of Trips") +
  theme_minimal(base_size = 10) +
  theme(
...
ggplot(brt_2017,
  ...
  scale_fill_brewer(palette = "Set3") +
  labs(title = "Percentage of  Multimodal BRT Trips in 2017 (out-mex)",
       x = "BRT Lines",
       y = "Percentage of Trips") +
  theme_minimal(base_size = 10) +
  theme(
...
ggplot(brt_2007,
  ...
  scale_fill_brewer(palette = "Set3") +
  labs(title = "Percentage of  Multimodal BRT Trips in 2007 (out-mex)",
       x = "BRT Lines",
       y = "Percentage of Trips") +
  theme_minimal(base_size = 10) +
  theme(
...
ggplot(non_brt_2007,
  ...
  scale_fill_brewer(palette = "Set3") +
  labs(title = "Percentage of  Multimodal Non BRT Bus Trips in 2007 (out-mex)",
       x = "Non BRT Bus Lines",
       y = "Percentage of Trips") +
  theme_minimal(base_size = 10) +
  theme(
...
ggplot(non_brt_2017,
  ...
  scale_fill_brewer(palette = "Set3") +
  labs(title = "Percentage of  Multimodal Non BRT Bus Trips in 2017 (out-mex)",
       x = "Non BRT Bus Lines",
       y = "Percentage of Trips") +
  theme_minimal(base_size = 10) +
  theme(
...
highcap<-read.csv("data/out-mex-high-cap.csv")
...
ggplot(
  ...
  scale_fill_brewer(palette = "Set3") +
  labs(
    title = "Percentage of Trips by High-Capacity Mode in 2007 (out-mex)",
    x = "Mode of Transportation",
    y = "Percentage of Trips (%)"
  ) +
  theme_minimal() +
...
ggplot(
  ...
  scale_fill_brewer(palette = "Set3") +
  labs(
    title = "Percentage of Trips by High-Capacity Mode in 2017 (out-mex)",
    x = "Mode of Transportation",
    y = "Percentage of Trips (%)"
  ) +
  theme_minimal() +
